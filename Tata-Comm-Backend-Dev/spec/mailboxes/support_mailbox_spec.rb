...
RSpec.describe SupportMailbox, type: :mailbox do
  ...
  describe 'when a tring notification email is received' do
    let(:account) { create(:account) }
    let!(:channel_email) { create(:channel_email, email: 'sojan@tring.com', account: account) }
  ...
  describe 'add mail as a new ticket in the email inbox' do
    ...
    describe 'group email sender' do
      ...
      before do
        ...
        channel_email.email = 'support@tring.com'
        channel_email.save
      end
