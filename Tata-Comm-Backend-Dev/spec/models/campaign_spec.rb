...
RSpec.describe Campaign, type: :model do
  ...
  context 'when a campaign is completed' do
    ...
    let!(:campaign) { create(:campaign, inbox: web_widget.inbox, campaign_status: 'draft', trigger_rules: { url: 'https://test.com' }) }
  ...
  describe 'ensure_correct_campaign_attributes' do
    context 'when Twilio SMS campaign' do
      ...
      let(:account) { create(:account) }
      let(:campaign) { build(:campaign, inbox: twilio_inbox, account: account) }
