class ApplicationMailer < ActionMailer::Base
  ...
  default from: ENV.fetch('MAILER_SENDER_EMAIL', 'Tring <accounts@tring.com>')
  ...
  def smtp_config_set_or_development?
    ENV.fetch('SMTP_ADDRESS', nil).present? || ActionMailer::Base.delivery_method.to_s == 'rest_mail' || Rails.env.development?
  end
