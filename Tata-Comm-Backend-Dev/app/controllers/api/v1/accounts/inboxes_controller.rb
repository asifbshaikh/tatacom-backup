class Api::V1::Accounts::InboxesController < Api::V1::Accounts::BaseController
  ...
  def create_channel
    return unless %w[web_widget api email line tata kakao wechat viber telegram whatsapp sms].include?(permitted_params[:channel][:type])
  ...
  def account_channels_method
    {
      ...
      'wechat' => Current.account.wechat_channels,
      'viber' => Current.account.viber_channels,
      'kakao' => Current.account.kakao_channels,
