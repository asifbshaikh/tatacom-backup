<template>
  <div class="user-thumbnail-box" :style="{ height: size, width: size }">
    ...
    />
    <img
      v-else-if="badge === 'Channel::Viber'"
      id="badge"
      class="source-badge"
      :style="badgeStyle"
      src="/integrations/channels/badges/viber.png"
    />
    <img
      v-else-if="badge === 'Channel::Wechat'"
      id="badge"
      class="source-badge"
      :style="badgeStyle"
      src="/integrations/channels/badges/wechat.png"
    />
    <img
      v-else-if="badge === 'Channel::Kakao'"
      id="badge"
      class="source-badge"
      :style="badgeStyle"
      src="/integrations/channels/badges/kakao.png"
    />
    <div
