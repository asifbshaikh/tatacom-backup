...
import {
  ...
  schemaWithMentions,
} from '@tring/prosemirror-schema/src/mentions/schema';

import {
  suggestionsPlugin,
  triggerCharacters,
} from '@tring/prosemirror-schema/src/mentions/plugin';
import { EditorState } from 'prosemirror-state';
import { defaultMarkdownParser } from 'prosemirror-markdown';
import { wootWriterSetup } from '@tring/prosemirror-schema';
...
import '@tring/prosemirror-schema/src/woot-editor.css';
import {
