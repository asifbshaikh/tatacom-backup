<template>
  ...
  >
    ...
    />
    <img
      v-if="channel.key === 'viber'"
      src="~dashboard/assets/images/channels/viber.png"
    />
    <img
      v-if="channel.key === 'wechat'"
      src="~dashboard/assets/images/channels/wechat.png"
    />
    <img
      v-if="channel.key === 'kakao'"
      src="~dashboard/assets/images/channels/kakao.png"
    />
    <img
