...
export default {
  ...
  computed: {
    ...
    isATataInbox() {
      return this.currentInbox.channel_type === 'Channel::Tata';
    },
    isAViberInbox() {
      return this.currentInbox.channel_type === 'Channel::Viber';
    },
    isAEmailInbox() {
    ...
    message() {
      ...
      if (this.isATataInbox) {
        return `${this.$t('INBOX_MGMT.FINISH.MESSAGE')}. ${this.$t(
          'INBOX_MGMT.ADD.TATA.API_CALLBACK.SUBTITLE'
        )}`;
      }
      if (this.isAViberInbox) {
        return `${this.$t('INBOX_MGMT.FINISH.MESSAGE')}. ${this.$t(
          'INBOX_MGMT.ADD.VIBER.API_CALLBACK.SUBTITLE'
        )}`;
      }
