<template>
  <div class="column content-box">
          ...
          <tbody>
            <tr v-for="item in inboxesList" :key="item.id">
              ...
              <td>
                ...
                <span v-if="item.channel_type === 'Channel::Viber'">
                  Viber
                </span>
                <span v-if="item.channel_type === 'Channel::Kakao'">
                  Kakao
                </span>
                <span v-if="item.channel_type === 'Channel::Wechat'">
                  Wechat
                </span>
              ...
              <td>
                <div class="button-wrapper">
                  ...
                  <woot-button
                    v-if="isAdmin"
                    v-tooltip.top="$t('INBOX_MGMT.SCANNER.TOOLTIP_TEXT')"
                    variant="smooth"
                    color-scheme="secondary"
                    size="tiny"
                    class-names="grey-btn"
    ...
    <woot-confirm-delete-modal
      v-if="showScannerPopup"
      :show.sync="showScannerPopup"
      :title="$t('INBOX_MGMT.SCANNER.TITLE')"
      :message="confirmDeleteMessage"
      :confirm-text="deleteConfirmText"
      :reject-text="deleteRejectText"
      :confirm-value="selectedInbox.name"
