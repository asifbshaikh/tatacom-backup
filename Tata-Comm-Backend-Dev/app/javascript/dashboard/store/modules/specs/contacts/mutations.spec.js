...
describe('#mutations', () => {
  describe('#SET_CONTACTS', () => {
    it('set contact records', () => {
      ...
      mutations[types.SET_CONTACTS](state, [
        { id: 2, name: 'contact2', email: 'contact2@tring.com' },
        { id: 1, name: 'contact1', email: 'contact1@tring.com' },
      ]);
      expect(state.records).toEqual({
        1: {
          id: 1,
          name: 'contact1',
          email: 'contact1@tring.com',
        },
        2: {
          id: 2,
          name: 'contact2',
          email: 'contact2@tring.com',
        },
      });
  ...
  describe('#SET_CONTACT_ITEM', () => {
    it('push contact data to the store', () => {
      const state = {
        records: {
          1: { id: 1, name: 'contact1', email: 'contact1@tring.com' },
        },
        sortOrder: [1],
      };
      ...
      expect(state.records).toEqual({
        1: { id: 1, name: 'contact1', email: 'contact1@tring.com' },
        2: { id: 2, name: 'contact2', email: 'contact2@tring.com' },
      });
  ...
  describe('#EDIT_CONTACT', () => {
    it('update contact', () => {
      ...
      expect(state.records).toEqual({
        1: { id: 1, name: 'contact2', email: 'contact2@tring.com' },
      });
    });
  });
