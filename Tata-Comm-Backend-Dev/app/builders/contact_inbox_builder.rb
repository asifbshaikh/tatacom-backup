class ContactInboxBuilder
  ...
  def perform
    ...
    return unless ['Channel::TwilioSms', 'Channel::Sms', 'Channel::Email', 'Channel::Api', 'Channel::Whatsapp', "Channel::TataSmsc"].include? @inbox.channel_type
