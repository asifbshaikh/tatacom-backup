...
json.hmac_identifier resource.hmac_identifier if GlobalConfig.get('TRING_INBOX_HMAC_KEY')['TRING_INBOX_HMAC_KEY'].present?
json.id resource.id
...
json.app_id resource.active_account_user&.account&.account_setting&.app_id
json.accounts do
