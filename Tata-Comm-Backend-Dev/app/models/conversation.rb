...
class Conversation < ApplicationRecord
  ...
  before_validation :update_channel_details
  ...
  def update_channel_details
    self.channel_id = inbox.channel_id
    self.channel_type =  inbox.channel_type
  end
  ...
  def mute!
    # stop making conversation as resolved 
    # resolved!
  ...
  def conversation_open_by_bot_callbacks
    dispatcher_dispatch(CONVERSATION_OPENED)
  end
