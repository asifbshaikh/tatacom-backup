...
class User < ApplicationRecord
  ...
  has_many :contact_support_mails, dependent: :destroy_async
  has_many :contact_reports, dependent: :delete_all
  ...
  # Used internally for Tring in Tring
  def hmac_identifier
    hmac_key = GlobalConfig.get('TRING_INBOX_HMAC_KEY')['TRING_INBOX_HMAC_KEY']
  ...
  def will_save_change_to_password_changed_at?
