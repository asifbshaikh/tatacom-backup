...
const Viber = ({
  ...
  const channelTypes = [
    { id: 'promotion', value: 'inboxes.viber.promotion' },
    { id: 'transaction', value: 'inboxes.viber.transaction' },
  ];
  return (
    <>
      <Formik
            ...
            <Row>
              <Colxx xxs="12">
                <h2 className="mb-4 font-weight-bold">
                  <IntlMessages id="inboxes.viber.title" />
                </h2>
                <p>
                  <IntlMessages id="inboxes.viber.desc" />
                </p>
                <FormGroupCoustom
                  identifier="channelName"
                  errors={errors}
                  touched={touched}
                  identifierLabel="inboxes.viber.channel_name.label"
                  placeholder="inboxes.viber.channel_name.place_holder"
                  required={true}
                />
                <FormGroupCoustom
                  ...
                  errors={errors}
                  touched={touched}
                  identifierLabel="inboxes.viber.channel_type.label"
                  type="select"
                ...
                <FormGroupCoustom
                  ...
                  errors={errors}
                  touched={touched}
                  identifierLabel="inboxes.viber.service_id.label"
                  placeholder="inboxes.viber.service_id.place_holder"
                  required={true}
                />
