...
import EmailTargetAudience from 'containers/campaigns/email/EmailTargetAudience';
...
describe('SmsTargetAudience btns click', () => {
  ...
  it('handle next button click channel type is email', async () => {
    mockData.channelType = 'email';
    render(
      <CustomWrapper>
        <EmailTargetAudience
          formRef={ref}
  ...
  it('handle previous button click channel type is email', async () => {
    mockData.channelType = 'email';
    render(
      <CustomWrapper>
        <EmailTargetAudience
