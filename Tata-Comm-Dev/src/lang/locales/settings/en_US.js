module.exports = {
  PROFILE_SETTINGS: {
    ...
    AVATAR_DELETE_FAILED:
      'There is an error while deleting avatar, please try again',
    ...
    AFTER_EMAIL_CHANGED:
      'Your profile has been updated successfully, please login again as your login credentials are changed',
    FORM: {
      ...
      API: {
        UPDATE_SUCCESS:
          'Your notification preferences are updated successfully',
        UPDATE_ERROR:
          'There is an error while updating the preferences, please try again',
      },
      ...
      DISPLAY_NAME: {
        ...
        PLACEHOLDER:
          'Please enter a display name, this would be displayed in conversations',
      },
      AVAILABILITY: {
        LABEL: 'Availability',
      ...
      EMAIL: {
        ...
        PLACEHOLDER:
          'Please enter your email address, this would be displayed in conversations',
      },
      CURRENT_PASSWORD: {
  ...
  CREATE_ACCOUNT: {
    NO_ACCOUNT_WARNING:
      'Uh oh! We could not find any Engage accounts. Please create a new account to continue.',
