module.exports = {
  AGENT_MGMT: {
    ...
    SIDEBAR_TXT:
      "<p><b>Agents</b></p> <p> An <b>Agent</b> is a member of your Customer Support team. </p><p> Agents will be able to view and reply to messages from your users. The list shows all agents currently in your account. </p><p> Click on <b>Add Agent</b> to add a new agent. Agent you add will receive an email with a confirmation link to activate their account, after which they can access Engage and respond to messages. </p><p> Access to Engage's features are based on following roles. </p><p> <b>Agent</b> - Agents with this role can only access inboxes, reports and conversations. They can assign conversations to other agents or themselves and resolve conversations.</p><p> <b>Administrator</b> - Administrator will have access to all Engage features enabled for your account, including settings, along with all of a normal agents' privileges.</p>",
    AGENT_TYPES: {
    ...
    ADD: {
      ...
      API: {
        ...
        EXIST_MESSAGE:
          'Agent email already in use, Please try another email address',
    ...
    EDIT: {
      ...
      PASSWORD_RESET: {
        ...
        ADMIN_SUCCESS_MESSAGE:
          'An email with reset password instructions has been sent to the agent',
